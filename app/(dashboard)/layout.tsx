...
export default async function DashboardLayout({
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="bg-alpha-bg">
        <header className="flex h-14 md:h-16 shrink-0 items-center gap-2 border-b border-white/5 bg-alpha-bg/50 px-4 md:px-6 backdrop-blur-md">
